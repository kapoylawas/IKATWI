    ...
    <div class="container mx-auto">
        <div class="flex items-center justify-between">
            ...
            <ul class="flex items-center justify-center gap-5">
                <li>
                    <a href="/" class="flex items-center text-lg font-semibold text-white">
                        ...
                        {{-- <img src="{{ asset('fisio.svg') }}" class="icon icon-tabler icon-tabler-brand-tabler"  width="24" height="24"> --}}
                         IKATWI
                    </a>
                </li>
                    ...
                    <div class="relative" x-data="{ isOpen: false }">
                        <button @click="isOpen = !isOpen" @keydown.escape="isOpen = false"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="w-5 h-5 icon icon-tabler icon-tabler-category-2" width="24" height="24"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" x-show="!isOpen"
                                class="w-4 h-4 icon icon-tabler icon-tabler-chevron-down" width="24"
                        ...
                        <ul x-cloak x-show="isOpen" @click.away="isOpen = false"
                            class="absolute left-0 z-20 w-48 py-1 mt-2 overflow-hidden font-normal border rounded-lg shadow bg-slate-800 border-slate-700">

                            <li>
                                <a
                                    class="flex items-center p-3 text-sm text-white rounded-lg hover:text-blue-500">
                                    <img src="" class="object-cover w-5 h-5" />
                                    <span class="ml-2">222222</span>
                                </a>
                            </li>
                                ...
                                <li>
                                    <a href=""
                                        ...
                                        <span class="ml-2">VISI DAN MISI </span>
                                    </a>
                                </li>
                                <li>
                                    <a href=""
                                        ...
                                        <span class="ml-2">ALAMAT DAN LOKASI</span>
                                    </a>
                                </li>
                                <li>
                                    <a href=""
                                        ...
                                        <span class="ml-2">DAFTAR ID WILAYAH</span>
                                    </a>
                                </li>
                                <li>
                                    <a href=""
                                        ...
                                        <span class="ml-2">DAFTAR ID CABANG</span>
                                    </a>
                                </li>
                                <li>
                                    <a href=""
                                        ...
                                        <span class="ml-2">DIREKTOR ANGGOTA</span>
                                    </a>
                                </li>
                        </ul>
                    </div>
                            ...
                            class="absolute left-0 z-20 w-48 py-1 mt-2 overflow-hidden font-normal border rounded-lg shadow bg-slate-800 border-slate-700">
                                ...
                                <li>
                                    <a href="#"
                                        class="flex items-center p-3 text-sm text-white rounded-lg hover:text-blue-500">
                                        <img src="#" class="object-cover w-5 h-5" />
                                        <span class="ml-2">asdasdasd</span>
                                    </a>
                                </li>
                ...
                <li class="hidden lg:flex">
                    <a href=""
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 icon icon-tabler icon-tabler-message-2"
                ...
                {{-- <li class="hidden lg:flex">
                    <a href=""
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="w-5 h-5 icon icon-tabler icon-tabler-source-code" width="24" height="24"
                            viewBox="0 0 24 24" stroke-width="1.25" stroke="currentColor" fill="none"
                            stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
            ...
            <div class="items-center hidden gap-2 text-white md:flex">
                ...
                @endguest
                @auth
                    <div class="px-4 py-2 border rounded-lg bg-slate-900 border-slate-700">
                        <a href="">
                            <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="flex items-center gap-1 md:hidden">
                <div class="px-4 py-2 text-white border rounded-lg bg-slate-900 border-slate-700">
                    <a href="">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="icon icon-tabler icon-tabler-basket w-5 h-5 {{ Route::is('cart.index') ? 'text-blue-500' : '' }}"
                            width="24" height="24" viewBox="0 0 24 24" stroke-width="1.25"
                    ...
                    <ul x-cloak x-show="isOpen" @click.away="isOpen = false"
                        ...
                        <li>
                            <div class="relative" x-data="{ isOpen: false }">
                                <button @click="isOpen = !isOpen" @keydown.escape="isOpen = false"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="w-5 h-5 icon icon-tabler icon-tabler-category-2" width="24"
                                        height="24" viewBox="0 0 24 24" stroke-width="1.25" stroke="currentColor"
                                        fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                        <path d="M14 4h6v6h-6z"></path>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" x-show="isOpen"
                                        class="w-4 h-4 icon icon-tabler icon-tabler-chevron-up" width="24"
                                        height="24" viewBox="0 0 24 24" stroke-width="1.25" stroke="currentColor"
                                        fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                        <polyline points="6 15 12 9 18 15"></polyline>
                                ...
                                <ul x-cloak x-show="isOpen" @click.away="isOpen = false" class="py-1 mt-2">
                                    {{-- @foreach ($categories as $category)
                                        <li>
                                            <a href="{{ route('category', $category->slug) }}"
                                                class="flex items-center p-3 ml-3 text-sm text-white hover:text-blue-500">
                                                <img src="{{ $category->image }}" class="object-cover w-5 h-5" />
                        ...
                        <li>
                            <a href=""
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="w-5 h-5 icon icon-tabler icon-tabler-message-2" width="24"
                                    height="24" viewBox="0 0 24 24" stroke-width="1.25" stroke="currentColor"
                                    fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                    <path
                        ...
                        <li>
                            <a href=""
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="w-5 h-5 icon icon-tabler icon-tabler-source-code" width="24"
                                    height="24" viewBox="0 0 24 24" stroke-width="1.25" stroke="currentColor"
                                    fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                        ...
                        @guest
                            <li class="border-t border-gray-700 border-dashed">
                                <a href="{{ route('login') }}"
                                    class="flex items-center gap-2 p-3 text-sm font-semibold text-white rounded-lg hover:text-blue-500">
                                    <svg xmlns="http://www.w3.org/2000/svg"
